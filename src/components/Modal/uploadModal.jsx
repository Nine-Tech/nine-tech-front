...
const uploadModal = () => {
    ...
    return (
        ...
        <>
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-body align-self-center">
                            ...
                            <button type="button" className="btn btn-secondary" onClick={addDocument}>Selecione um arquivo (.xlsx)</button>
                        </div>
            ...
            <div className={`modal-backdrop ${showModal ? "show" : ""}`} style={{ display: showModal ? "block" : "none" }}>
